...
[`waldo::compare()`](https://waldo.r-lib.org/dev/reference/compare.md)
is inspired by [`all.equal()`](https://rdrr.io/r/base/all.equal.html),
but takes additional care to generate actionable insights by:
...
When comparing atomic vectors,
[`compare()`](https://waldo.r-lib.org/dev/reference/compare.md) produces
diffs (thanks to [diffobj](https://github.com/brodieG/diffobj)) that
highlight additions, deletions, and changes, along with a little
context:
...
- Change
  ...
  ![](reference/figures/README/unnamed-chunk-4.svg)
...
- Long vectors with short differences only show local context around
  ...
  ![](reference/figures/README/unnamed-chunk-5.svg)
...
- The default display is to show the vectors one atop the other:
  ...
  ![](reference/figures/README/unnamed-chunk-6.svg)
...
- If there’s not enough room for that, the two vectors are shown
  ...
  ![](reference/figures/README/unnamed-chunk-7.svg)
...
- And if there’s still not enough room for side-by-side, the each
  ...
  ![](reference/figures/README/unnamed-chunk-8.svg)
...
- Unnamed lists are compared by position:
  ...
  ![](reference/figures/README/unnamed-chunk-10.svg)
...
- Named lists, including data frames, are compared by name. For example,
  ...
  ![](reference/figures/README/unnamed-chunk-11.svg)
...
- Recursion can be arbitrarily deep:
  ...
  ![](reference/figures/README/unnamed-chunk-12.svg)
